...
Este capítulo detalla el proceso de implementación del diseño sobre la Basys~3, incluyendo los resultados de síntesis e implementación en Vivado, las restricciones de temporización y de pines empleadas, el proceso de depuración en hardware apoyado en el \ac{ILA} y, finalmente, las pruebas realizadas sobre la placa física.
